      ...
      <div class="admin-container">
        <aside class="admin-sidebar">
          <el-menu :default-active="activeMenu" class="admin-menu" router unique-opened>
            ...
            <el-sub-menu index="tutor-management">
              <template #title>
                <el-icon>
                  <Reading />
                </el-icon>
              ...
              <el-menu-item index="/admin/tutor-profiles">
                <el-icon>
                  <List />
                </el-icon>
                <template #title>家教信息</template>
              </el-menu-item>
              <el-menu-item index="/admin/tutor-certifications">
                <el-icon>
                  <Select />
                </el-icon>
                <template #title>认证审核</template>
              </el-menu-item>
              <el-menu-item index="/admin/tutor-resumes">
                <el-icon>
                  <Document />
                </el-icon>
                <template #title>家教简历</template>
              </el-menu-item>
            </el-sub-menu>
            ...
            <el-sub-menu index="student-management">
              ...
              <el-menu-item index="/admin/student-requests">
                <el-icon>
                  <List />
                </el-icon>
                <template #title>学生需求</template>
              </el-menu-item>
            </el-sub-menu>

            <el-sub-menu index="appointment-management">
              <template #title>
                <el-icon>
                  <Tickets />
                </el-icon>
...
import { User, ArrowDown, Monitor, Document, List, ChatDotRound, Reading, School, Tickets, Folder, Collection, Warning, CircleClose, Select, Bell } from '@element-plus/icons-vue'
