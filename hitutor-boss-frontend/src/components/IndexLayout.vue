<template>
  <div class="index-layout">
    <header class="header" role="banner">
      <div class="container">
        <div class="logo-area">
          <h1 class="logo" aria-label="好会帮 - 家教运营管理系统">好会帮</h1>
        </div>
    ...
    <main class="main-content" role="main">
      <section class="hero-section" aria-labelledby="hero-title">
        <div class="container">
          <div class="hero-content">
            <h1 id="hero-title" class="hero-title">HiTutor 好会帮家教平台</h1>
      ...
      <section id="features" class="features-section" aria-labelledby="features-title">
        <div class="container">
          <h2 id="features-title" class="section-title">家教运营管理系统功能</h2>
    ...
    <footer class="footer" role="contentinfo">
      <div class="container">
        ...
        <div class="footer-bottom">
          <p>&copy; 2024-2026 好会帮 - 家教运营管理系统</p>
          <div class="icp-info">
...
const FEATURES_DATA = [
  {
    ...
    icon: Key,
    title: '家教信息发布',
    description: '便捷的家教信息发布功能，支持家教老师快速发布个人家教信息。'
  },
  {
    id: 2,
    icon: Box,
    title: '需求智能匹配',
    description: '智能匹配算法，为学生家长快速找到合适的家教老师。'
  },
  {
    id: 3,
    icon: DataLine,
    title: '在线沟通预约',
    description: '内置即时通讯和预约管理，支持双方便捷沟通和预约安排。'
  }
]
